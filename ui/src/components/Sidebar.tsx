                      ...
                      >
                        ...
                        {isSelected && !extractMode && (
                          <div
                            ...
                            className="absolute -top-2.5 left-2 z-20 flex items-center gap-1 bg-lumvale-primary text-[var(--color-lumvale-bg)] text-[10px] font-bold px-2 py-0.5 rounded-full shadow-lg select-none"
                          >
