...
- Name: ui\tests\workspace.spec.ts >> Workspace E2E >> can upload a PDF, extract, and merge
- Location: ui\tests\workspace.spec.ts:15:3
...
> 16  |     await page.goto('/');
  ...
  110 |     
  111 |     // Submit
  112 |     await page.getByText('Lock PDF').click();
  113 | 
  114 |     // 6. Test Help Menu & Updates
  115 |     await page.getByText('Help').click();
  116 |     await expect(page.getByText('Check for Updates...')).toBeVisible();
```